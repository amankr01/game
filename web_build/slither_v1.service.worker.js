...
/** @type {string} */
const CACHE_VERSION = '1779391893|7443332451';
/** @type {string} */
const CACHE_PREFIX = 'Puzzle Game : Sl-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'slither_v1.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["slither_v1.html","slither_v1.js","slither_v1.offline.html","slither_v1.icon.png","slither_v1.apple-touch-icon.png","slither_v1.audio.worklet.js","slither_v1.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["slither_v1.wasm","slither_v1.pck"];
